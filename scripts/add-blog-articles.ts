/**
 * Script to add sample blog articles to Firestore
 * Run this from the admin panel or via a one-time script
 */
...
export async function addSampleArticles() {
  try {
    ...
    console.log(`✅ Successfully added ${sampleArticles.length} articles to Firestore`);
...
if (typeof window === "undefined") {
  ...
  console.log("Articles ready to be added. Import and call addSampleArticles()");
}
