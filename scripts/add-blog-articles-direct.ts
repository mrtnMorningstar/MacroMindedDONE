/**
 * Script to add blog articles directly to Firestore
 * Run with: npx tsx scripts/add-blog-articles-direct.ts
 */
...
const sampleArticles = [
  {
    ...
    published: true,
    thumbnail: "https://images.unsplash.com/photo-1490645935967-10de6ba17061?w=1200&h=600&fit=crop",
    content: `
  ...
  },
  {
    ...
    published: true,
    thumbnail: "https://images.unsplash.com/photo-1556910103-1c02745aae4d?w=1200&h=600&fit=crop",
    content: `
  ...
  },
  {
    ...
    published: true,
    thumbnail: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=1200&h=600&fit=crop",
    content: `
  ...
  },
  {
    ...
    published: true,
    thumbnail: "https://images.unsplash.com/photo-1482049016688-2d3e1b311543?w=1200&h=600&fit=crop",
    content: `
  ...
  },
  {
    ...
    published: true,
    thumbnail: "https://images.unsplash.com/photo-1505576391880-b3f9d713dc4f?w=1200&h=600&fit=crop",
    content: `
...
async function addArticles() {
  try {
    console.log("🚀 Starting to add articles to Firestore...");
    ...
    console.log(`\n🎉 Successfully added ${results.length} articles to Firestore!`);
    console.log("📝 Article IDs:", results);
    process.exit(0);
  } catch (error) {
